...
(function (unsafeWindow, Store, $, $$, Sleep = ToEagle._Sleep) {
    // 防抖节流
    const shake = {
        Data: new Set,
        /**
     ...
     * @returns
     */
    function Fun_toPromise(Fun, ...Variable) {
    ...
    function FunMian() {
       ...
       `,
        ...
        function NewElement(ElementType = "div", AddCode = "", id, AddSelect, options) {
            function CallType(a) { return Object.prototype.toString.call(a); }
            // 如果传入的是元素则不新建而是复制元素
        ...
        function SetButAll() {
            var _a;
            // 获取所有卡片
            const domNodeList = (_a = $(Main.Main)) === null || _a === void 0 ? void 0 : _a.querySelectorAll(Main.Card);
        ...
        // --------------------------------------------------------------------------------------------
        //为按钮添加CSS
        NewElement("style", `\n#GotuEagle{color: grey;stroke:grey;fill: grey;}#GotuEagle svg:hover{stroke:#ff8200;fill: #ff8200;}#GotuEagle:hover{color: #ff8200;}#GotuEagle a{color: grey;}`, "HMCss", "body");
        //debugger;
